...
// Experimental AHB Prot disable patch
// not tested
const u8 ahbprot_old[] = { 0x80, 0x00, 0x0d, 0xfe,
			   0x0d, 0x80, 0x00, 0x64,
			   0x0d, 0x8b, 0x42, 0x02,
			   0x7F, 0xFF, 0xF2, 0x01 };
const u8 ahbprot_patch[] = {  0xFF, 0xFF, 0xFF, 0xFF,
			      0x0d, 0x80, 0x00, 0x64,
			      0x0d, 0x8b, 0x42, 0x02,
			      0xFF, 0xFF, 0xFF, 0xFF };
...
u32 IOSPATCH_Apply() {
	...
	//count += apply_patch("ahbprot_permissions", ahbprot_old, sizeof(ahbprot_old), ahbprot_patch, sizeof(ahbprot_patch), 0);
    }
    return count;
}
